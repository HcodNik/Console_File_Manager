...
@pytest.mark.parametrize("num, res_", [(0, 0.0),
                                       (4, 2.0),
                                       (100, 10.0),
                                       (math.pi, 1.7724538509055159)])
def test_math_sqrt(num, res_):
    assert math.sqrt(num) == res_
...
# Тестирование функции math.hypot()

@pytest.mark.parametrize("a, b, res", [(3, 4, 5.0),
                                       (5, 12,13.0),
                                       (8, 15, 17.0),
                                       (-3, -4, 5.0),
                                       (-5, 12, 13.0),
